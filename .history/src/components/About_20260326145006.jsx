...
const About = () => {
  const features = [
    ...
    },
    {
      ...
      description: '300+ pieces of content, 200,000+ organic views via MediaConnectStudios',
    },
    {
      icon: Users,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                I also founded <span className="text-primary-400 font-semibold">MediaConnectStudios (MCS)</span>, a content and strategy company working with multiple Irish brands. Through MCS, I produced 300+ pieces of content generating 200,000+ organic views and built strong networks across Irish entrepreneurship — which directly inspired the product problems I now solve through software.
              </p>
              <p className="text-gray-300 text-base leading-relaxed">
                I'm actively seeking a <span className="text-white font-semibold">Software Engineering Internship (Summer 2026)</span> or a <span className="text-white font-semibold">Graduate / Full-Time role</span> where I can build real, user-focused software.
              </p>
