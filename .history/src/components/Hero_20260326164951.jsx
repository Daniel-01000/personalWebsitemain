    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-gray-300">Open to Internship & Graduate Roles</span>
        </motion.div>
        ...
        >
          ...
          <span className="text-base sm:text-lg md:text-xl text-gray-400">
            I'm actively seeking a Software Engineering Internship (Summer 2026) or a Graduate&nbsp;/&nbsp;Full-Time role where I can build real, user-focused software.
          </span>
        </motion.p>
