...
const Hero = () => {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/ayomidesofola', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/daniel-sofola/', label: 'LinkedIn' },
  ];
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-gray-300">Open to internships & graduate roles</span>
        </motion.div>
        ...
        >
          Final-year <span className="text-white font-semibold">Computer Science student</span> at TU Dublin — building real products with React, React Native & Node.js.
          <br />
          <span className="text-base sm:text-lg md:text-xl text-gray-400">
            Founder of ClientIn & MediaConnectStudios. Seeking a Software Engineering Internship (Summer 2026) or Graduate role.
          </span>
        </motion.p>
        ...
        >
          ...
          <Link to="/blog" className="btn-secondary w-full sm:w-auto text-center inline-flex items-center justify-center gap-2">
            <BookOpen size={18} />
            Read My Blog
          </Link>
