...
const Blog = () => {
	...
	// Blog list view
	return (
		<section id="blog" className="py-20 px-4 sm:px-6 lg:px-8 min-h-screen">
			<div className="max-w-7xl mx-auto">
				{/* Back to Portfolio */}
				<Link
					to="/"
					className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-200 mb-10 group"
				>
					<ArrowLeft size={18} className="group-hover:-translate-x-1 transition-transform duration-200" />
					Back to Portfolio
				</Link>
