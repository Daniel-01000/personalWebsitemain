...
import { Mail, MapPin, Send, Github, Linkedin, Heart } from 'lucide-react';
...
const Contact = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/ayomidesofola', label: 'GitHub', target: '_blank' },
    { icon: Linkedin, href: 'https://linkedin.com/in/ayomidesofola', label: 'LinkedIn', target: '_blank' },
  ];
